...
BloomTheme daisyToBloomTheme(String id, Map<String, String> data) {
  final isLight = data['color-scheme'] == 'light';
  ...
  final neutralContent = oklchToColor(data['--color-neutral-content']!);
  ...
  return BloomTheme(
    ...
    border: neutral,
    accent: primary,
    accentDark: _darken(primary, 0.2),
    accentText: primaryContent,
    textPrimary: baseContent,
    textSecondary: neutralContent,
    textHint: baseContent.withValues(alpha: 0.5),
    success: oklchToColor(data['--color-success']!),
    error: oklchToColor(data['--color-error']!),
    warning: oklchToColor(data['--color-warning']!),
    info: oklchToColor(data['--color-info']!),
  );
}
