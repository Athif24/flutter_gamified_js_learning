                    ...
                    child: Column(
                      children: [
                        ProfileHeroCard(
                          ...
                          profile: p,
                          ref: ref,
                          onEditProfile: () => showEditProfile(context, ref, t, p),
                        ),
                        SizedBox(height: S.scale(context, 16)),
                        ProfileStatsGrid(t: t, profile: p),
                        SizedBox(height: S.scale(context, 16)),
                        LayoutBuilder(
                          builder: (_, constraints) {
                            ...
                            if (isTablet) {
                              return Row(
                                ...
                                children: [
                                  Expanded(
                                    child: ProfileLearningSummary(t: t, profile: p),
                                  ),
                            ...
                            return Column(
                              children: [
                                ProfileLearningSummary(t: t, profile: p),
                                SizedBox(height: S.scale(context, 16)),
                                ProfileRecentActivity(t: t, entries: p.recentXp),
                              ],
                            );
                          },
                        ),
