...
class ProfileModel {
  ...
  factory ProfileModel.fromJson(Map<String, dynamic> j) {
    ...
    final joinedAtRaw = u['created_at']?.toString() ?? u['createdAt']?.toString() ?? u['joinedAt']?.toString();
    ...
    return ProfileModel(
      ...
      maxJewels     : (s?['max_jewels'] ?? 10000) as int,
      ...
      recentXp      : rx != null
          ? rx.map((e) => RecentXpEntry.fromJson(e as Map<String, dynamic>)).toList()
          : const [],
    );
  }
}
